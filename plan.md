...
- [ ] Define source ID conventions for PMID, DOI, NCT, and manual sources.
...
1. Write source ID conventions and ingestion rules.
2. Tighten placeholder schemas for `outcome`, `result`, `eligibility_decision`, and `risk_of_bias`.
