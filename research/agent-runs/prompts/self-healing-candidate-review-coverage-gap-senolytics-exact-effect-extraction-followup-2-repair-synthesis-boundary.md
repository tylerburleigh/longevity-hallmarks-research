...
- agent_run_id: self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary
- agent_role: supervisor_agent
- prompt_file: research/agent-runs/prompts/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary.md
- prompt_template_file: docs/prompts/codex-agents/supervisor-review.md
- output_path: research/agent-runs/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary.json
- output_schema_path: schemas/agent-run.codex-output.schema.json
- jsonl_log_path: research/agent-runs/logs/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary.jsonl
- workspace_path: /tmp/lhr-codex-worktrees/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary-20260628T182939z
- isolation: git_worktree
- sandbox: workspace-write
- approval_policy: never
- job_file: ops/codex-jobs/live/generated-self-healing/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary.json
...
Codex job specification:
{
  ...
  "id": "self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary",
  "name": "Self-healing repair: candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary",
  "summary": "Required review lane is missing: synthesis_boundary.",
  "lifecycle_status": "ready",
  "agent_role": "supervisor_agent",
  "mode": "agent_directed",
  "prompt_file": "docs/prompts/codex-agents/supervisor-review.md",
  "context_pack_path": "ops/supervisor-review-context-packs/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary.json",
  "output_path": "research/agent-runs/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary.json",
  "jsonl_log_path": "research/agent-runs/logs/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary.jsonl",
  "scope": {
  ...
  "expected_outputs": {
    ...
    "candidate_change_id": "candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary-repair",
    "required_review_lanes": [
      "synthesis_boundary"
    ],
    "proposed_record_paths": [
      "data/candidate-changes/candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary-repair.json",
      "data/evidence-reviews/coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary.json"
    ],
  ...
  "orchestration": {
    "read_sets": [
      "context_pack:self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary",
      ...
      "triage_job:candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair"
    ],
    "write_sets": [
      "candidate_change:candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary-repair",
      "candidate_review:coverage-gap-senolytics-exact-effect-extraction-followup-2-repair/synthesis_boundary",
      "path:data/candidate-changes/candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary-repair.json",
      "path:data/evidence-reviews/coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary.json"
    ],
    "conflict_keys": [
      "candidate_change:candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair-synthesis-boundary-repair",
      "candidate_review:coverage-gap-senolytics-exact-effect-extraction-followup-2-repair/synthesis_boundary"
  ...
  "notes": [
    "Generated from ops/triage-state.v1.json recommended_jobs[] item candidate-review-coverage-gap-senolytics-exact-effect-extraction-followup-2-repair.",
