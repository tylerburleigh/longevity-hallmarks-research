...
- agent_run_id: self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping
- agent_role: supervisor_agent
- prompt_file: research/agent-runs/prompts/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping.md
- prompt_template_file: docs/prompts/codex-agents/supervisor-review.md
- output_path: research/agent-runs/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping.json
- output_schema_path: schemas/agent-run.codex-output.schema.json
- jsonl_log_path: research/agent-runs/logs/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping.jsonl
- workspace_path: /tmp/lhr-codex-worktrees/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping-20260627T205943z
- isolation: git_worktree
- sandbox: workspace-write
- approval_policy: never
- job_file: ops/codex-jobs/live/generated-self-healing/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping.json
...
Codex job specification:
{
  ...
  "id": "self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping",
  "name": "Self-healing repair: candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping",
  "summary": "Required review lane is missing: taxonomy_mapping.",
  "lifecycle_status": "ready",
  "agent_role": "supervisor_agent",
  "mode": "agent_directed",
  "prompt_file": "docs/prompts/codex-agents/supervisor-review.md",
  "context_pack_path": "ops/supervisor-review-context-packs/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping.json",
  "output_path": "research/agent-runs/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping.json",
  "jsonl_log_path": "research/agent-runs/logs/self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping.jsonl",
  "scope": {
  ...
  "expected_outputs": {
    ...
    "candidate_change_id": "candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping-repair",
    "required_review_lanes": [
      "taxonomy_mapping"
    ],
    "proposed_record_paths": [
      "data/candidate-changes/candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping-repair.json",
      "data/evidence-reviews/coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping.json"
    ],
  ...
  "orchestration": {
    "read_sets": [
      "context_pack:self-healing-candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping",
    ...
    "write_sets": [
      "candidate_change:candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping-repair",
      "candidate_review:coverage-gap-senolytics-exact-effect-extraction-repair/taxonomy_mapping",
      "path:data/candidate-changes/candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping-repair.json",
      "path:data/evidence-reviews/coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping.json"
    ],
    "conflict_keys": [
      "candidate_change:candidate-review-coverage-gap-senolytics-exact-effect-extraction-repair-taxonomy-mapping-repair",
      "candidate_review:coverage-gap-senolytics-exact-effect-extraction-repair/taxonomy_mapping"
